                ...
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        <div class="header-top_list">
                            <span class="icon-phone"></span>085xxxxxxxxx
                        </div>
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>khabibalfatach@gmail.com
                        </div>
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>Kebun Jeruk, Jakarta Barat
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <a href="<?php echo site_url('');?>" class="navbar-brand nav-brand2"><img class="img img-responsive" width="50px;" src="<?php echo base_url().'theme/images/logo.jpg' ?>"></a>
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('guru');?>">Ustadz</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('siswa');?>">Santri</a>
                                </li>
                                <li class="nav-item">
                              ...
                              <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('bayar_zakat');?>">Bayar Zakat</a>
                            </li>
                        </ul>
                    </div>
                </nav>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="d-block" src="<?php echo base_url().'theme/images/logo2.jpg'?>" alt="First slide">
            ...
            <div class="carousel-item">
                <img class="d-block" src="<?php echo base_url().'theme/images/logo.jpg'?>" alt="Second slide">
                <div class="carousel-caption d-md-block">
                    <div class="slider_title">
            ...
            <div class="carousel-item">
                <img class="d-block" src="<?php echo base_url().'theme/images/logo1.jpg'?>" alt="Third slide">
                <div class="carousel-caption d-md-block">
                    <div class="slider_title">
...
<section class="clearfix about about-style2">
    <div class="container">
        <div class="row">
           ...
           <div class="col-md-4">
            <img src="<?php echo base_url().'theme/images/santri.jpg'?>" class="img-fluid about-img" alt="#">
        </div>
    </div>
</div>
</section>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-3 chart_bottom">
                ...
                <div class="chart-text">
                    <p><span class="counter"><?php echo $tot_guru;?></span> Ustadz
                    </p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3 chart_bottom chart_top">
                ...
                <div class="chart-text">
                    <p><span class="counter"><?php echo $tot_siswa;?></span> Santri
                    </p>
                </div>
            </div>
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <div class="foot-logo">
                    ...
                    <p><?php echo date('Y');?> © copyright by people. <br>All rights reserved.</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="sitemap">
            ...
            <div class="col-md-3">
              <div class="sitemap">
                  <h3>Akademik</h3>
                  <ul>
                    <li><a href="<?php echo site_url('guru');?>">Ustadz</a></li>
        ...
        <div class="col-md-3">
            <div class="address">
                <h3>Hubungi Kami</h3>
                <p><span>Alamat: </span> Jakarta Barat</p>
                <p>Email : khabibfebby@gmail.com
                    <br> Phone : 085xxxxxxxxx</p>
